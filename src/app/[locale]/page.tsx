...
export default function Home() {
   ...
   return (
      <div className='container mx-auto pb-16'>
         <div className='flex flex-col md:flex-row justify-center md:justify-start items-center space-y-5 h-[calc(100svh-80px)] mt-[80px]'>
            <Image
               ...
               priority
            />
            <div className='w-full flex flex-col space-y-1.5 md:h-96 z-40'>
               <div className='flex justify-center md:justify-start'>
                  <h2 className='font-semibold lg:text-5xl text-4xl font-koho text-slate-900 dark:text-gray-100 text-center hidden md:block'>
                     Hi!&nbsp;
                  </h2>
         ...
         <div id='experience' className='flex flex-col gap-10 pt-32 md:pt-52'>
            <h2 className='font-semibold lg:text-5xl text-4xl font-koho text-slate-900 dark:text-gray-100 text-start lg:text-center pb-10'>
               My Experience
            </h2>
               ...
               <div className='w-full pl-5 lg:pr-5 flex items-end'>
                  <div className='flex gap-5 relative'>
                     ...
                     <div className=' flex flex-col gap-3 lg:gap-5 max-w-full lg:max-w-[500px] p-3 lg:p-8 xl:p-10 border-2 border-slate-400 rounded-xl transition hover:lg:scale-105 hover:lg:translate-x-5 ease-in-out duration-300 origin-right'>
                        <div>
                           <div >
                              <h2 className='flex gap-1.5 lg:gap-3 items-center text-xs xs:text-sm lg:text-lg xl:text-xl'>
                                 <strong className='text-base lg:text-xl xl:text-2xl'>
                                    Ztoa Group
                                 </strong>
                                 &nbsp;March 2023 - March 2024
                              </h2>
                           </div>
                           <h3 className='text-gray-600 dark:text-gray-300 text-start text-sm lg:text-lg'>
            ...
            <div className='flex gap-3 flex-wrap justify-center md:justify-start lg:w-4/6'>
               {skills.map((skill) => (
                  <Badge
                     key={skill.id}
                     variant="outline"
                     className='text-lg border-slate-900 dark:border-gray-200 dark:hover:bg-gray-200 dark:hover:text-slate-900 hover:bg-slate-900 hover:text-white'
                  >
                     {skill.name}
                  </Badge>
               ))}
         ...
         <div className='flex flex-col gap-10 pt-32 md:pt-52'>
            <h2 id='contact-me' className='font-semibold lg:text-5xl text-4xl font-koho text-slate-900 dark:text-gray-100 text-center md:text-start'>
               Contact Me
            </h2>
            <pre className='text-center md:text-start text-gray-600 dark:text-gray-300 text-wrap'>
               You can contact me vai&nbsp;
               <Link
                  href={"mailto:trasok9090@gmail.com"}
                  className='underline underline-offset-2 font-semibold'
               >
                  trasok9090@gmail.com
               </Link>
               &nbsp;or form below.
            </pre>
            <div>
